...
bool MaterialApp::InitializeApp(HINSTANCE hInstance)
{
...
bool MaterialApp::BuildFrameResources()
{
...
bool MaterialApp::BuildMeshGeometry()
{
	//generate mesh data
...
bool MaterialApp::BuildRenderItems()
{
...
void MaterialApp::DrawItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem>& renderItems)
{
	UINT objCBVIndex = 0;
...
bool MaterialApp::BuildDescriptorHeap()
{
...
bool MaterialApp::BuildRootSignature()
{
...
void MaterialApp::Update(float deltaTime)
{
...
void MaterialApp::OnKeyboardAxisEvent(KEY_TYPE key)
{
	switch (key)
	{
	case KEY_TYPE::KEY_W:
...
void MaterialApp::OnMouseButtonActionEvent(MOUSE_BUTTON_TYPE mouseButton, PRESS_STATE pState)
{
...
void MaterialApp::OnMouseMove(float xPos, float yPos, float zPos, float xSpeed, float ySpeed, float zSpeed)
{
...
void MaterialApp::CmdListClearRtvAndDsv(ID3D12GraphicsCommandList* cmdList, D3D12_CPU_DESCRIPTOR_HANDLE rtv, D3D12_CPU_DESCRIPTOR_HANDLE dsv, float clearColor[4], float depth, unsigned char stencil)
{
	cmdList->ClearRenderTargetView(rtv, clearColor, 0, nullptr);
	cmdList->ClearDepthStencilView(dsv, D3D12_CLEAR_FLAG_DEPTH | D3D12_CLEAR_FLAG_STENCIL, depth, stencil, 0, nullptr);
}

void MaterialApp::CmdListSetVptAndSciRct(ID3D12GraphicsCommandList* cmdList)
{
...
void MaterialApp::CmdListOpenRtvAndDsv(ID3D12GraphicsCommandList* cmdList, ID3D12Resource* rtv, ID3D12Resource* dsv)
{
...
void MaterialApp::CmdListCloseRtvAndDsv(ID3D12GraphicsCommandList* cmdList, ID3D12Resource* rtv, ID3D12Resource* dsv)
{
